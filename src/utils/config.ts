...
{
  "data": [
    {"媒体类型":"GG","渠道名": "42122-APP001", "消耗/U": 1234.56, "展示": 1234, "点击量": 100, "需人工复查": false}
  ]
}
...
如果你对某行数据（比如渠道名前缀是否被遮挡或截断、数值是否模糊不清）的识别没有绝对把握，请在该行的JSON记录中将 "需人工复查" 字段设置为 true，否则设置为 false。
